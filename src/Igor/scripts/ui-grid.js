    ...
    angular.module('ui.grid').config(['$provide', function ($provide) {
        $provide.decorator('i18nService', ['$delegate', function ($delegate) {
            $delegate.add('es', {
                ...
                groupPanel: {
                    description: 'Arrastre un encabezado de columna aquÃ­ y soltarlo para agrupar por esa columna.'
                },
                search: {
                    placeholder: 'Buscar...',
                    showingItems: 'ArtÃ­culos Mostrando:',
    ...
    angular.module('ui.grid').config(['$provide', function ($provide) {
        $provide.decorator('i18nService', ['$delegate', function ($delegate) {
            $delegate.add('fa', {
                ...
                groupPanel: {
                    description: 'ÛŒÚ© Ø¹Ù†ÙˆØ§Ù† Ø³ØªÙˆÙ† Ø§ÛŒÙ†Ø¬Ø§ Ø±Ø§ Ø¨Ø±Ø¯Ø§Ø± Ùˆ Ø¨Ù‡ Ú¯Ø±ÙˆÙ‡ÛŒ Ø§Ø² Ø¢Ù† Ø³ØªÙˆÙ† Ø¨ÛŒØ§Ù†Ø¯Ø§Ø².'
                },
                search: {
                    placeholder: 'Ø¬Ø³ØªØ¬Ùˆ...',
                    showingItems: 'Ù†Ù…Ø§ÛŒØ´ Ù…ÙˆØ±Ø¯Ù‡Ø§:',
                    selectedItems: 'Ù…ÙˆØ±Ø¯Ù‡Ø§ÛŒ Ø§Ù†ØªØ®Ø§Ø¨\u200cØ´Ø¯Ù‡:',
                    totalItems: 'Ù‡Ù…Ù‡Ù” Ù…ÙˆØ±Ø¯Ù‡Ø§:',
                    size: 'Ø§Ù†Ø¯Ø§Ø²Ù‡Ù” ØµÙØ­Ù‡:',
                    first: 'ØµÙØ­Ù‡Ù” Ø§ÙˆÙ„',
                    next: 'ØµÙØ­Ù‡Ù” Ø¨Ø¹Ø¯',
                    previous: 'ØµÙØ­Ù‡Ù” Ù‚Ø¨Ù„',
                    last: 'Ø¢Ø®Ø±ÛŒÙ† ØµÙØ­Ù‡'
                },
                menu: {
                    text: 'Ø§Ù†ØªØ®Ø§Ø¨ Ø³ØªÙˆÙ†\u200cÙ‡Ø§:'
                }
            });
            return $delegate;
        }]);
    ...
    angular.module('ui.grid').config(['$provide', function ($provide) {
        $provide.decorator('i18nService', ['$delegate', function ($delegate) {
            $delegate.add('fr', {
                ...
                groupPanel: {
                    description: 'Faites glisser un en-tÃªte de colonne ici et dÃ©posez-le vers un groupe par cette colonne.'
                },
                search: {
                    placeholder: 'Recherche...',
                    showingItems: 'Articles Affichage des:',
                    selectedItems: 'Ã‰lÃ©ments Articles:',
    ...
    angular.module('ui.grid').config(['$provide', function ($provide) {
        $provide.decorator('i18nService', ['$delegate', function ($delegate) {
            $delegate.add('zh-cn', {
                ...
                groupPanel: {
                    description: 'æ‹–æ›³è¡¨å¤´åˆ°æ­¤å¤„ä»¥è¿›è¡Œåˆ†ç»„'
                },
                search: {
                    placeholder: 'æœç´¢...',
                    showingItems: 'å½“å‰æ˜¾ç¤ºæ¡ç›®ï¼š',
                    selectedItems: 'é€‰ä¸­æ¡ç›®ï¼š',
                    totalItems: 'æ¡ç›®æ€»æ•°ï¼š',
                    size: 'æ¯é¡µæ˜¾ç¤ºæ•°ï¼š',
                    first: 'å›žåˆ°é¦–é¡µ',
                    next: 'ä¸‹ä¸€é¡µ',
                    previous: 'ä¸Šä¸€é¡µ',
                    last: 'å‰å¾€å°¾é¡µ'
    ...
    angular.module('ui.grid').config(['$provide', function ($provide) {
        $provide.decorator('i18nService', ['$delegate', function ($delegate) {
            $delegate.add('zh-tw', {
                ...
                groupPanel: {
                    description: 'æ‹–æ‹‰è¡¨é ­åˆ°æ­¤è™•ä»¥é€²è¡Œåˆ†çµ„'
                },
                search: {
                    placeholder: 'æœå°‹...',
                    showingItems: 'ç›®å‰é¡¯ç¤ºç­†æ•¸ï¼š',
                    selectedItems: 'é¸å–ç­†æ•¸ï¼š',
                    totalItems: 'ç¸½ç­†æ•¸ï¼š',
                    size: 'æ¯é é¡¯ç¤ºï¼š',
                    first: 'ç¬¬ä¸€é ',
                    next: 'ä¸‹ä¸€é ',
                    previous: 'ä¸Šä¸€é ',
...
angular.module('ui.grid').run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('ui-grid/uiGridMenu',
      "<div class=\"ui-grid-menu\"><div class=\"ui-grid-menu-inner\" ng-show=\"shown\"><ul class=\"ui-grid-menu-items\"><li ng-repeat=\"item in menuItems\" ui-grid-menu-item=\"\" action=\"item.action\" title=\"item.title\" active=\"item.active\" icon=\"item.icon\" shown=\"item.shown\" context=\"item.context\"></li></ul></div></div>"
    );
